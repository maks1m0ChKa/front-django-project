      ...
      >
        ...
        <ul class="nav col-12 col-lg-auto me-lg-auto mb-2 justify-content-center mb-md-0">
          ...
          <li>
            <div class="dropdown">
              <a
                class="dropdown-toggle nav-link px-2 text-white"
                href="#"
                role="button"
              ...
              <ul class="dropdown-menu">
                <li>
                  <RouterLink
                    :to="{ name: 'products', query: { category: 1 } }"
                    class="dropdown-item"
                    >Laptops</RouterLink
                  >
                </li>
                <li>
                  <RouterLink
                    :to="{ name: 'products', query: { category: 2 } }"
                    class="dropdown-item"
                    >Phones</RouterLink
                  >
                </li>
                <!-- <li>
                  <RouterLink
                    :to="{ name: 'products', query: { category: 3 } }"
                    class="dropdown-item"
                    >Refrigerator</RouterLink
                  >
                </li> -->
                <li>
                  <RouterLink
                    :to="{ name: 'products', query: { category: 4 } }"
                    class="dropdown-item"
                ...
                <li>
                  <RouterLink
                    :to="{ name: 'products', query: { category: 5 } }"
                    class="dropdown-item"
                    >PC-Games</RouterLink
                  >
                </li>
                <li>
                  <RouterLink
                    :to="{ name: 'products', query: { category: 6 } }"
                    class="dropdown-item"
                    >Consols</RouterLink
                  >
                </li>
          ...
          <li><RouterLink to="/cart" class="nav-link px-2 text-white">Basket</RouterLink></li>
